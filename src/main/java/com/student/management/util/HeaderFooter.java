...
public class HeaderFooter extends PdfPageEventHelper {
	...
	public void onEndPage(PdfWriter writer, Document document) {
		try {
			...
			log.error("Exception caught in HeaderFooter class while adding header and footer for PDF:{}  " , e.getMessage());
		}
...
* //			header.addCell(logo);
*/			
			String filesName = env.getProperty("fhr.logo");
			if(filesName != null) {
			ClassPathResource resource = new ClassPathResource(filesName);
